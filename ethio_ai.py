...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Main menu layout follows the clean Telegram inline-keyboard style
    # used by subscription/store bots: one large primary button, then
    # compact two-column rows underneath. Telegram controls the actual
    # button color; the code controls the layout, labels and icons.
    keyboard = [
        [
            InlineKeyboardButton(
                "💎 Upgrade to Premium",
