...
async def button_handler(
    ...
    if data == "invite_friend":
        invite_link = get_referral_link(user.id)
        await query.message.reply_text(
            "👥 INVITE FRIEND\n\n"
            "Share this link with your friends to invite them to Ethio AI:\n\n"
            f"{invite_link}\n\n"
            "They can open the link and start the bot."
        )
        return
...
async def chat(
    ...
    # FREE users can use text AI chat without a Premium subscription.
    user_message = (
